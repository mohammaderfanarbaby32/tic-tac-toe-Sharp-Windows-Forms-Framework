...
namespace WindowsFormsApp6
{
    public partial class Form1 : Form
    {
        ...
        private void lbl4_Click(object sender, EventArgs e)
        {
            ...
            else { MessageBox.Show("خانه ی مورد نظر پر است"); }
        ...
        private void mohammad1(Control Z, bool p)
        {
            ...
            {
                qt++;
                MessageBox.Show(name1.Text + " برد ");
                a0 = 0;
                a = 0;
                b1 = 0;
                c = 0;
            ...
            {
                qt++;
                MessageBox.Show(name1.Text + " برد "); a0 = 0;
                a = 0;
                b1 = 0;
                c = 0;
                d = 0;
            ...
            {
                Qt++;
                MessageBox.Show(name2.Text + " برد "); a0 = 0;
                a = 0;
                b1 = 0;
                c = 0;
                d = 0;
            ...
            {
                QtQ++;
                MessageBox.Show("دو بازیکن برنده شدند"); a0 = 0;
                a = 0;
                b1 = 0;
                c = 0;
                d = 0;
